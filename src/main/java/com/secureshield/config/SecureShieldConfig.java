...
public final class SecureShieldConfig {
    ...
    private static final long DEFAULT_LOGIN_LOCK_MS = 5 * 60 * 1000;
    ...
    public int maxLoginAttempts() {
        return (int) parseLong(read("secureshield.login.max.attempts", "SECURESHIELD_LOGIN_MAX_ATTEMPTS", String.valueOf(DEFAULT_MAX_LOGIN_ATTEMPTS)), DEFAULT_MAX_LOGIN_ATTEMPTS);
    }

    public long lockDurationMs() {
        return parseLong(read("secureshield.login.lock.ms", "SECURESHIELD_LOGIN_LOCK_MS", String.valueOf(DEFAULT_LOGIN_LOCK_MS)), DEFAULT_LOGIN_LOCK_MS);
    }
